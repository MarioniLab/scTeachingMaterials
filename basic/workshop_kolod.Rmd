...
grepl("^ERCC", "ERCC-001")
#A# grepl("^ERCC", "TERCC-001")
#A# grepl("^ERCC-[0-9]+", "ERCC-001")
```
</div>
...
#A# isOutlier(x)
#A# isOutlier(x, batch=b)
```

```{r}
# What is the minimum library size threshold?
#H# retained <- 
#A# retained <- sce[,!low.lib]
...
```{r}
#H# plot(sizeFactors(sce, 'ERCC'), sizeFactors(sce),
#A# plot( ,
